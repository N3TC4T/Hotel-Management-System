    ...
    <div class="container top">
	 ...
	 <div class="col-md-3">
	  <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="room_no" value="<?php echo set_value('room_no'); ?>" >
            </div>
          </div>
         </div>
	 ...
	 <div class="col-md-3">
	  <div class="form-group">
            ...
            <div class="col-sm-10">
	      	      <?php
		echo form_dropdown('type_id', $option_room_type, set_value('type_id'), 'class="span2" id="type_id"');
		?>
            </div>
          </div>
         </div>
	 ...
	 <div class="col-md-3">
	  <div class="control-group">
            ...
            <div class="controls">
              	<?php
		echo form_dropdown('floor', $option_floor, set_value('floor'), 'class="span2"');
		?>
            </div>
          </div>
         </div>          
